...
class ROSMonitor_testmon_default_offline_silent(Node):
...
def main(args=None):
	...
	log = '/home/parallels/code/ros2_rosmonintoring/ros2_code/logs/testmon_default_offline_silent.txt'
	actions = {}
	actions['chatter']=('log',0)
	monitor = ROSMonitor_testmon_default_offline_silent('testmon_default_offline_silent',log,actions)
	rclpy.spin(monitor)
	monitor.ws.close()
