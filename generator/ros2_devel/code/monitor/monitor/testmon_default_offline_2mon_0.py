...
class ROSMonitor_testmon_default_offline_2mon_0(Node):
...
def main(args=None):
	...
	log = '/home/parallels/code/ros2_rosmonintoring/ros2_code/logs/testmon_default_offline_2mon_0.txt'
	actions = {}
	actions['chatter']=('log',0)
	monitor = ROSMonitor_testmon_default_offline_2mon_0('testmon_default_offline_2mon_0',log,actions)
	rclpy.spin(monitor)
	monitor.ws.close()
